...
var writeIEEE754 = require('bson/lib/bson/float_parser').writeIEEE754,
  Long = require('bson/lib/bson/long').Long,
  Map = require('bson/lib/bson/map'),
  Binary = require('bson/lib/bson/binary').Binary;

var normalizedFunctionString = require('bson/lib/bson/parser/utils').normalizedFunctionString;
